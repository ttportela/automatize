...
#     importer(['S', 'results2df', 'printLatex', 'STATS', 'format_stats'], globals())
    from automatize.results import results2df, printLatex, format_stats, STATS
...
#                         print(jstr)
#                         import automatize.results as re
                        for i in range(1, num_runs+1):
...
#     import pandas as pd
    import glob2 as glob
    from automatize.results import get_stats, format_stats, STATS
