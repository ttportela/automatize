...
# from main import importer, def_random_seed
# importer(['S', 'ACC4All', 'results2df'], locals())

# TODO: def_random_seed(random_num=1, seed_num=1)

if len(sys.argv) < 2:
    print('Please run as:')
    print('\tpython MAT-MC_MLP_RF.py', 'res_path', 'prefix', '[OPTIONAL:', 'save_results', 'modelfolder]')
    print('OR as:')
    print('\tpython MAT-MC_MLP_RF.py', 'res_path', 'prefix', 'True', 'modelfolder')
    exit()
