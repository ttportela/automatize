...
if len(sys.argv) < 2:
    print('Please run as:')
    print('\tpython MAT-MC_SVM.py', 'res_path', 'prefix', '[OPTIONAL:', 'save_results', 'modelfolder]')
    print('OR as:')
    print('\tpython MAT-MC_SVM.py', 'res_path', 'prefix', 'True', 'modelfolder')
    exit()
...
ACC4All(res_path, prefix, save_results, modelfolder, classifiers=['SVM'])